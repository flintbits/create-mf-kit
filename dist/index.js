      ...
      constructor() {
        ...
        this.ourEmit = function(event, data, ...args2) {
          ...
          if (self2.requests > 0 || stdin.emit === self2.ourEmit) {
            ...
            Reflect.apply(self2.oldEmit, this, [event, data, ...args2]);
          } else {
            Reflect.apply(process.stdin.emit, this, [event, data, ...args2]);
          }
        };
      }
      start() {
...
// lib/createRemote.js
var createRemote_exports = {};
__export(createRemote_exports, {
  createNewRemoteApp: () => createNewRemoteApp
});
...
var prompts, fs, path, ora, chalk, TEMPLATE_BASE, CONTAINER_WEBPACK_PATH;
var init_createRemote = __esm({
  "lib/createRemote.js"() {
    prompts = require_prompts3();
    fs = require_lib2();
    path = require("path");
    ora = require_ora();
    chalk = require_source();
    TEMPLATE_BASE = path.resolve(__dirname, "../templates");
    CONTAINER_WEBPACK_PATH = path.resolve(
      process.cwd(),
...
async function mfeScaffold() {
  try {
    ...
    await fs2.copy(selectedTemplateDir, targetDir);
    spinner.succeed("Project created successfully!");
    console.log(chalk2.green("\n Project created at:"), chalk2.yellow(targetDir));
    console.log(chalk2.cyan("\n Run the following to get started\n"));
    console.log(`  cd ${projectName}`);
    console.log(chalk2.white(`  cd container >> npm install >> npm start`));
    console.log(chalk2.cyan("\n In a new terminal:"));
    console.log(chalk2.white(`  cd app1 >> npm install >> npm start`));
  } catch (err) {
    console.error(chalk2.red("Failed to scaffold project:"), err.message);
    process.exit(1);
  }
}
var prompts2, fs2, path2, ora2, chalk2, TEMPLATE_BASE2;
var init_scaffold = __esm({
  "lib/scaffold.js"() {
    prompts2 = require_prompts3();
    fs2 = require_lib2();
    path2 = require("path");
    ora2 = require_ora();
    chalk2 = require_source();
    TEMPLATE_BASE2 = path2.resolve(__dirname, "../templates");
  }
});

// bin/index.js
var { createNewRemoteApp: createNewRemoteApp2 } = (init_createRemote(), __toCommonJS(createRemote_exports));
var { mfeScaffold: mfeScaffold2 } = (init_scaffold(), __toCommonJS(scaffold_exports));
var args = process.argv.slice(2);
if (args[0] === "add" && args[1]) {
  createNewRemoteApp2(args[1]);
} else {
  mfeScaffold2();
}
